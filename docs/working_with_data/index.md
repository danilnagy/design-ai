...
def transDistance(pt, pl):
    pt_5 = rh.Point3d(pt)
    t = rh.Transform.PlanarProjection(pl)
    pt_5.Transform(t)
    return pt.DistanceTo(pt_5)
    
def smaller(pt_1, pt_2):
    if (pt_1 < pt_2):
        return pt_1
    else:
        return pt_2
        
def makePlane(pt, pt_all):
    pt_5 = rh.Point3d(pt)
    pt_all.remove(pt)
    pl = rh.Plane(pt_all[0], pt_all[3], pt_all[2])
    t = rh.Transform.PlanarProjection(pl)
    pt_5.Transform(t)
    return pt.DistanceTo(pt_5)
...
for i, row in enumerate(pts[:-1]):
    for j, pt_1 in enumerate(row[:-1]):
        ...
        if ((pt_1.DistanceTo(pt_1t) < pt_2.DistanceTo(pt_2t)) and (pt_1.DistanceTo(pt_1t) < pt_3.DistanceTo(pt_3t)) and (pt_1.DistanceTo(pt_1t) < pt_4.DistanceTo(pt_4t))): # 1 smallest
        ...
        elif ((pt_2.DistanceTo(pt_2t) < pt_1.DistanceTo(pt_1t)) and (pt_2.DistanceTo(pt_2t) < pt_3.DistanceTo(pt_3t)) and (pt_2.DistanceTo(pt_2t) < pt_4.DistanceTo(pt_4t))): # 2 smallest
        ...
        elif ((pt_3.DistanceTo(pt_3t) < pt_2.DistanceTo(pt_2t)) and (pt_3.DistanceTo(pt_3t) < pt_1.DistanceTo(pt_1t)) and (pt_3.DistanceTo(pt_3t) < pt_4.DistanceTo(pt_4t))): # 3 smallest
        ...
        elif ((pt_4.DistanceTo(pt_4t) < pt_2.DistanceTo(pt_2t)) and (pt_4.DistanceTo(pt_4t) < pt_1.DistanceTo(pt_1t)) and (pt_4.DistanceTo(pt_4t) < pt_3.DistanceTo(pt_3t))): # 4 smallest
